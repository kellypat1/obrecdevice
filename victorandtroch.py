...
def qo():
	...
	for num in lisths[1]:
		for i in np.arange(0.5, 3.5, 0.1):
			...
			p1list.append(p1)
	for i in p1list:
		if degree1<=1.43 and i<=0.8:
			p2=float(0.0033*degree1+0.062)
			p3=float(1.08*degree1-3.45)
			k4 = float(math.exp(p3 * i) * p2 * (9.81 * np.power(num, 3)) ** 0.5)
			listqo.append(k4)
		elif degree1 <=1.43 and i>0.8 and i<=2:
			p2=0.2
			p3=float(1.57*degree1-4.88)
			k4 = float(math.exp(p3 * i) * p2 * (9.81 * np.power(num, 3)) ** 0.5)
			listqo.append(k4)
		elif degree1>=1.73 and i<=0.8:
			p2=0.11
			p3=-1.85
			k4 = float(math.exp(p3 * i) * p2 * (9.81 * np.power(num, 3)) ** 0.5)
			listqo.append(k4)
		elif degree1>1.73 and i>0.8 and i<=2:
			p2=0.2
			p3=-2.6
			k4= float(math.exp(p3 * i) * p2 * (9.81 * np.power(num, 3)) ** 0.5)
			listqo.append(k4)
		elif degree1>1.43 and degree1<1.73:
			p2=0.2
			p3=1.57*degree1-4.88
			k4 = float(math.exp(p3 * i) * p2 * (9.81 * np.power(num, 3)) ** 0.5)
			listqo.append(k4)
